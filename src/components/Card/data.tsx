...
export const contractABI = {
    ...
    "EFOO2EFOO": config.EFOO2EFOO_CONTRACT_ABI,
...
export const contractAddress = {
    ...
    "EFOO2EFOO": config.EFOO2EFOO_CONTRACT_ADDRESS,
...
export const contractName = {
    ...
    "EFOO2EFOO": config.EFOO2EFOO_CONTRACT_NAME,
...
export const tokenDecimal = {
    ...
    "EFOO": config.EFOO_TOKEN_DECIMALS,
