...
const Vote = ({
  ...
  const [newVoteAmount, setNewVoteAmount] = React.useState<string>('100');
  ...
  return (
    <div>
      <h3>
       BitX Launchpad DAO Vote <FontAwesomeIcon icon={faPersonBooth} className='text' /><br /><br /><br /><br />
      </h3>
      <div className='row'>
        <div className='col'>
          {question === undefined ||
          ...
          {question !== undefined && inProgress !== undefined && (
           ...
           <h3>  <FontAwesomeIcon icon={faCircleQuestion} className='text mr-1' /><b>Question :</b></h3> &nbsp;<br /><br /><br />
              {question}<br /><br /><br />
              {inProgress === 1 && (
                <div>
                  <i>Vote will be closed on 01.02.2023</i>
                </div>
              )}
              {inProgress === 0 && (
                <div>
                ...
                <div className='col-12'>
                  <div className='input-group mb-3'>
                    ...
                    <div className='input-group-append'>
                      <span className='input-group-text'>$BTX</span>
                    </div>
                  </div>
                </div>
                <div className='col-3'>
