        ...
        <div className='container'>
          <Col md={12} lg={6} className='custom-presale-col'>
            <div className='custom-presale-left'>
              <h1 className='custom-presale-header color-white'>BTX Sale Is {presale?.state == 'NotStarted' ? 'Coming' : (presale?.state == 'Started' ? 'Live' : 'Ended')}!</h1>

              {
                presale?.state == 'NotStarted' && (<div className='custom-timer-header'></div>)
              }
              {
                presale?.state == 'Started' && (<div className='custom-timer-header'></div>)
              }
              ...
              <div className='custom-presale-body'>
                ...
                <div className='custom-progress-container'>
                  ...
                  <div className='custome-progress-number color-white'>{presale?.total_bought_amount_in_esdt} / {presale?.token_sale_amount} BTX</div>
                </div>

                <div className='custom-presale-price'>1 EGLD = {presale?.exchange_rate} BTX</div>
          ...
          <Col md={12} lg={6} className='custom-presale-col'>
            <div className='custom-buy-card'>
              <div className='custom-buy-card-body'>
                <h3 className='custom-buy-card-header color-white'>Buy BTX</h3>
                ...
                <div className='custom-buy-card-amount'>
                  ...
                  <div className='custom-buy-card-amount-container'>
                    <input className='custom-buy-card-amount-input' type='number' disabled={false} value={buyAmountInEsdt} />
                    <span className='custom-buy-card-amount-unit color-white'>BTX</span>
                  </div>
                </div>
                ...
                <div style={{ paddingTop: '32px' }}>
                  <button className="custom-buy-card-buy-button" onClick={buyToken} >Buy BTX</button>
