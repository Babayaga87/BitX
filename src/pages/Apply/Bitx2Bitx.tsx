  ...
  return (
    <div className='card'> 
      <div className='stake_earn'>
       <div>
       <p className='heading'>  <h2>Full support for new projects</h2></p>
          <p>               </p>
        </div>
...
<tr>
  <td><br /><p className='heading'> <h4>VESTING</h4></p><br />
  <h5> <p className='heading'>Every project can use our BitLOCK dAPP for vesting TEAM tokens!</p><br />
  <p className='heading'>
 There is a 3% fee from the total amount of token vested.</p></h5>
 <br />
  
  </td>
  </tr>
  <tr>
  <td><br /> <p className='heading'>  <h4>SALES ROUNDS</h4> </p><br />
  <h5><p className='heading'>We take care of everything regarding presale/Sales. This include Smart Contracts and dAPP </p>
  <br />
  <p className='heading'>There is a 5% fee on the Sales Supply and 5% of the EGLD earned.</p></h5>
 <br />
  ...
  <tr>
  <td><br /> <p className='heading'> <h4>STAKING POOLS
 </h4> </p><br />
 <h5><p className='heading'>Let investors benefit from staking! When sales round will start a staking pool will be availlable!Every project can choose locked, undelegation time or APR!</p>
 <br />
 <p className='heading'>The fees are 8 EGLD and 10 EGLD in project tokens!</p></h5>
 <br />
  ...
  <tr>
  <td>            <br /> <p className='heading'> <h4>SPECIAL SALES
 </h4></p> <br />                      
 <h5>  <p className='heading'>All tokens received by BitX team will be used for special sales availlable only for BTX and BitXCoin stakers!</p>
          <br />
          <p className='heading'>The price for tokens will be sold in our condition in a separate sale round !</p></h5>
...
-  FUNDS IN EGLD <b>WILL BE PAID AFTER PRESALE / SALE ROUND</b> <br />
-  FUNDS IN PROJECT TOKEN <b>WILL BE PAID BEFORE PRESALE / SALE</b> !<br />
-  FOR <b>ALL INCLUSIVE PACKAGE</b> , STAKING POOL WILL BE ACTIVE WHEN PRESALE WILL START !
