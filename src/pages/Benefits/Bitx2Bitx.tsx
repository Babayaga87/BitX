...
<a href="./btx-pool">
      ...
      <img src={dollarPot}/>  <p>Stake now BitXCoin and enjoy all benefits</p>  <img src={dollarPot}/> 
      ...
      <div style={{ textAlign: "center", display: "flex", justifyContent: "center", gap: '20px' }}>
                     ...
                     <div className='custom-buy-card-info color-white'>BitXCOIN info :</div>
                  <div className='custom-buy-card-amount-header'> </div>
                  <div className='custom-buy-card-amount-header'>Total supply = 10.000 BitXCOIN</div>
  
                <div className='custom-buy-card-amount-header'>Can be buyed only with BTX</div>
             
              <div className='custom-buy-card-amount-header'>Will be 8 round with 1000 BitXCOIN each</div>
                <div className='custom-buy-card-amount-header'>#1 ROUND price = 4000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#2 ROUND price = 5000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#3 ROUND price = 6000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#4 ROUND price = 7000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#5 ROUND price = 8000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#6 ROUND price = 9000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#7 ROUND price = 10000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>#8 ROUND price =11000 BTX / BitxCOIN</div>
                <div className='custom-buy-card-amount-header'>* 80 % from BTX collected will be burned </div>
                <div className='custom-buy-card-amount-header'>* 20 % will be added as reward !</div>
