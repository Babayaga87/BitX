...
import BitxLogo from 'assets/img/token logos/BTX.png';
  ...
  return (
    <div className='card'>
      <div className='stake_earn'>
        <div>
          <img src={HetoLogo} />
          <p className='heading'>Stake BitXCoin</p>
        </div>
        <img src={arrow} />
        <div>
          <img src={BitxLogo} />
          <p className='heading'>Earn BTX</p>
        </div>
      </div>
      ...
      <div className='info'>
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.staked_amount : '-'} {HETO_TOKEN_TICKER}</p>
        </div>
        <div>
          <p className='heading'>My Unstaked</p>
          <p className='data'>{stakeAccount ? stakeAccount.unstaked_amount : '-'} {HETO_TOKEN_TICKER}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.collectable_amount : '-'} {HETO_TOKEN_TICKER}</p>
        </div>
      </div>
