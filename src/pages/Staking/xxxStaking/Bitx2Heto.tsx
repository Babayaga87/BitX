    ...
    <div className='card'>
      ...
      <div className='info'>
        ...
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.staked_amount : '-'} BTX4NFT</p>
        </div>
        <div>
          <p className='heading'>My Unstaked</p>
          <p className='data'>{stakeAccount ? stakeAccount.unstaked_amount : '-'} BTX4NFT</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className='data'>{stakeAccount ? stakeAccount.collectable_amount : '-'} BTX4NFT</p>
        </div>
      </div>
