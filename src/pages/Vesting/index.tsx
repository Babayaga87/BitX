    ...
    return (
        <div className="home-container">
                ...
                <Col sm="6" className="d-flex text-center align-items-center">
                    <div>
                        <div>
                            ...
                            <p className="text-left" style={{ color: "#23f7dd" }}>
                        ...
                        <Row className="mt-5">
                            <Col xs="4">
                                <div className="">
                                    ...
                                    <p className="mt-3 mb-1" style={{ color: "#23f7dd" }}>${lockSetting ? lockSetting.total_locked_value : '-'}</p>
                            ...
                            <Col xs="4">
                                <div className="">
                                    ...
                                    <p className="mt-3 mb-1" style={{ color: "#23f7dd" }}>{lockSetting ? lockSetting.total_locked_tokens.length : '-'}</p>
                            ...
                            <Col xs="4">
                                <div className="">
                                    ...
                                    <p className="mt-3 mb-1" style={{ color: "#23f7dd" }}>{lockSetting ? lockSetting.total_lock_count : '-'}</p>
            ...
            <div className="bitlock-vesting-list-box mt-5 mb-5">
                <p className="text-center" style={{ fontSize: "20px", fontWeight: "500", color: "#23f7dd" }}>Search A Smart Lock Address</p>
