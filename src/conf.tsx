...
// Heto Pool
export const HETO2HETO_CONTRACT_ADDRESS = 'erd1qqqqqqqqqqqqqpgq0nmr5j9jymds9yz2dk3lrrwampsxapw3n66qe4u3fq';
export const HETO2HETO_CONTRACT_ABI = 'abi/dice2dice.abi.json';
export const HETO2HETO_CONTRACT_NAME = 'BitxStake';
export const HETO_TOKEN_TICKER = 'BTX4NFT';
export const HETO_TOKEN_ID = 'BTX4NFT-8b78d7';
